...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Image with Elegant Charcoal Overlay matching the logo */}
      <div 
      ...
      >
        {/* Charcoal overlay matching logo background */}
      ...
      <div className="relative z-10 container mx-auto px-6 sm:px-8 py-32 sm:py-40 text-center max-w-4xl">
        ...
        {/* Description */}
        <p className="text-lg sm:text-xl text-white/80 mb-12 max-w-2xl mx-auto animate-fade-in-up leading-relaxed font-light">
          {t.hero.description}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-stretch sm:items-center animate-scale-in mb-16 max-w-lg mx-auto">
          <Button 
            ...
            className="w-full sm:w-auto sm:min-w-[200px] h-14 text-base font-semibold bg-primary text-charcoal hover:bg-primary/90 shadow-gold hover:shadow-elegant transition-all duration-300"
          >
          ...
          <Button 
            ...
            size="lg"
            asChild
            className="w-full sm:w-auto sm:min-w-[180px] h-14 text-base font-semibold bg-transparent border-white/30 text-white hover:bg-white/10 hover:border-primary/50 transition-all duration-300"
          >
        ...
        <div className="flex items-center justify-center gap-4 animate-fade-in mb-12">
          ...
          <div className="flex gap-3">
            <a 
              ...
              className="bg-white/5 hover:bg-primary p-2.5 rounded-full border border-white/10 hover:border-primary transition-all hover:scale-110"
            >
        ...
        {/* Trust Indicators */}
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 sm:gap-10 text-white/60 text-sm font-medium animate-fade-in-up">
