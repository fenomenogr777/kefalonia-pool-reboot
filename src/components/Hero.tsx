  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 sm:px-8 py-32 sm:py-36 md:py-44 text-center max-w-6xl">
        ...
        {/* Worry-Free Message */}
        <div className="bg-accent/20 backdrop-blur-md border-2 border-white/40 rounded-2xl px-6 py-5 mb-8 max-w-2xl mx-auto animate-scale-in shadow-2xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-10 animate-fade-in">
          <span className="text-white/80 text-sm font-medium">Ακολουθήστε μας:</span>
          <a 
            href="https://www.facebook.com/cleanpoolkefalonia" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full transition-all hover:scale-110"
          >
